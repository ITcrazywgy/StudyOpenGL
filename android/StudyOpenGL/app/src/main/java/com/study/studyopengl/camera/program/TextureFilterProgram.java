...
public class TextureFilterProgram extends ShaderProgram {
    ...
    public TextureFilterProgram(Context context) {
        super(context, R.raw.filter_base_vs, R.raw.filter_oes_fs);
